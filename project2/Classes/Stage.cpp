...
// <param = num> ステージ番号
Stage* Stage::createStageWithNumber(int num)
{
	Stage* p = new Stage();
...
bool Stage::init(const std::string& filename)
{
	if (!Layer::init())
	{
		return false;
